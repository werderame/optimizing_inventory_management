# Optimization Project Main Script
...
"""Uncomment to scrape today's recipes"""
...
d, i, w = ff.fefo_daily(demand, inventory, e_1, output_names=['d', 'i', 'w']) # Perfect FEFO Ops: 0% non-adherence
id, ii, iw = ff.fefo_daily(demand, inventory, e_2, output_names=['id', 'ii', 'iw'])  # Imperfect FEFO: 3% non-adherence
